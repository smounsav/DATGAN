...
class ResNet(nn.Module):
    def __init__(self, nc, block, num_blocks, num_classes=10):
...
class Cifar10ResNet(nn.Module):
    def __init__(self, nc, block, n, num_classes=10):
...
def ResNet18(nc):
    return ResNet(nc, BasicBlock, [2, 2, 2, 2],)


def ResNet20(nc):
    return Cifar10ResNet(nc, BasicBlock, n=3)


def ResNet32(nc):
    return Cifar10ResNet(nc, BasicBlock, n=5)


def ResNet34(nc):
    return ResNet(nc, BasicBlock, [3, 4, 6, 3])


def ResNet44(nc):
    return Cifar10ResNet(nc, BasicBlock, n=7)


def ResNet50(nc):
    return ResNet(nc, Bottleneck, [3, 4, 6, 3])
